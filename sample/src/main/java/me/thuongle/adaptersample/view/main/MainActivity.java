...
import me.thuongle.adaptersample.data.TaskRepositoryImpl;
import me.thuongle.adaptersample.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements MainContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityMainBinding binding = DataBindingUtil.setContentView(this, me.thuongle.adaptersample.R.layout.activity_main);
